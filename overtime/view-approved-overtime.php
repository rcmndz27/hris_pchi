     ...
     <div class="form-row mb-2">
        ...
        <div class="col-md-2">
            ...
            <?php if($empUserType == 'Team Manager'){   
                    ...
                    echo '</div>
                    <button type="submit" id="searchOtRep" class="btn btn-primary"><i class="fas fa-search-plus"></i> Generate
                    </button>';
                }else{
                    echo '
                    ...
                    <button type="submit" id="searchOtApp" class="btn btn-primary"><i class="fas fa-search-plus"></i> Generate
                    </button>';
                }
            ?>                                                  
    </div>
