    ...
    <div class="pt-3">
        <div class="row align-items-end justify-content-end">
            <div class="col-md-12 mb-3">
                <button type="button" class="btn btn-primary" id="mfdeductionEntry"><i class="fas fa-plus-circle"></i> ADD NEW DEDUCTION </button>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
            ...
            <div class="main-body">
                <fieldset class="fieldset-border">
                        ...
                        <div class="form-row">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-times-circle"></i> Cancel</button>
                                    <button type="button" class="btn btn-success" onclick="updateMfded()" ><i class="fas fa-check-circle"></i> Submit</button>
                                </div> 
                        </div> <!-- main body closing -->
                    </div> <!-- modal body closing -->
                </div> <!-- modal content closing -->
