    ...
    <div class="form-row">
        ...
        <div class="col-md-2">
            ...
            <?php if($empUserType == 'Team Manager'){   
                    ...
                    echo '</div>
                    <button type="submit" id="searchObRep" class="btn btn-primary"><i class="fas fa-search-plus"></i> Generate
                    </button>';
                }else{
                    echo '
                    ...
                    <button type="submit" id="searchObApp" class="btn btn-primary"><i class="fas fa-search-plus"></i> Generate
                    </button>';
                }
            ?>                                                 
    </div>
