...
function GetPayrollEmpList($action, $dtFrom, $dtTo,$location,$empCode,$emp_code){
    ...
    $param = array(":period_from" => $dtFrom, ":period_to" => $dtTo, ":location" => $location, ":status" => 'Active',$location, ":emp_code" => $emp_code);
    ...
    if($r){
        do {
            ...
            echo'<td><button type="button"class="btn btn-primary btn-sm mr-1 mb-1" 
