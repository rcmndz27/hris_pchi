    ...
    <div class="form-row mb-2">
        ...
        <div class="col-md-2">
            ...
            <?php if($empUserType == 'Team Manager'){   
                    ...
                    echo '</div>
                    <button type="submit" id="searchLeaveRep" class="btn btn-primary"><i class="fas fa-search-plus"></i> Generate
                    </button>';
                }else{
                    echo '
                    ...
                    <button type="submit" id="searchLeaveApp" class="btn btn-primary"><i class="fas fa-search-plus"></i> Generate
                    </button>';
                }
            ?>                    
