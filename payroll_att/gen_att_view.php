                      ...
                      <fieldset class="fieldset-border">
                            <div class="d-flex justify-content-center">
                             ...
                             <div class="form-row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <button type="button" id="search" class="btn btn-primary" onclick="genAttPay();">
                ...
                <div class="tab-pane fade" id="wfhome" role="tabpanel" aria-labelledby="wfhome-tab">
                    <fieldset class="fieldset-border">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <button type="button" id="search" class="btn btn-primary" onclick="genWfhPay();">
                                        <i class="fas fa-search-plus"></i>GENERATE                       
                                    </button> 
                                </div>
                            </div>
                ...
                <div class="tab-pane fade" id="offb" role="tabpanel" aria-labelledby="offb-tab">
                    <fieldset class="fieldset-border">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <button type="button" id="search" class="btn btn-primary" onclick="genObPay();">
                                        <i class="fas fa-search-plus"></i>GENERATE                       
                                    </button> 
                                </div>
                            </div>
                ...
                <div class="tab-pane fade" id="leave" role="tabpanel" aria-labelledby="leave-tab">
                    <fieldset class="fieldset-border">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <button type="button" id="search" class="btn btn-primary" onclick="genLeavePay();">
                                        <i class="fas fa-search-plus"></i>GENERATE                       
                                    </button> 
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="overtime" role="tabpanel" aria-labelledby="overtime-tab">
                        <fieldset class="fieldset-border">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <button type="button" id="search" class="btn btn-primary" onclick="genOtPay();">
                                            <i class="fas fa-search-plus"></i>GENERATE                       
                                        </button> 
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane fade" id="dtr" role="tabpanel" aria-labelledby="dtr-tab">
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="form-row">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <button type="button" id="search" class="btn btn-primary" onclick="genDTR();">
                                                <i class="fas fa-search-plus"></i>GENERATE                       
                                            </button> 
                                        </div>
                                    </div>
